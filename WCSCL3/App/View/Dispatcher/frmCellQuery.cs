    ...
    public partial class frmCellQuery : BaseForm
    {
        ...
        private void btnRefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ShelfCode.Clear();
                DataTable dtShelf = bll.FillDataTable("CMD.SelectShelf", new DataParameter("{0}", "Areacode='003'"));
                ...
                cellTable = bll.FillDataTable("WCS.SelectCell1", new DataParameter("{0}", "CMD_Area.AreaCode='003'"));
