...
namespace App.View.Task
{
    public partial class frmInStockTask :BaseForm
    {
        ...
        private void frmInStockTask_Load(object sender, EventArgs e)
        {
            ...
            dt.Rows.Add("高");
            BindAisleNo();
            this.cmbHeight.DataSource = dt.DefaultView;
            this.cmbHeight.ValueMember = "Height";
            this.cmbHeight.DisplayMember = "Height";
        }
        ...
        private void BindAisleNo()
        {
            ...
            { 
                new DataParameter("{0}", string.Format("AreaCode='{0}'",this.AreaCode))
            };
            ...
            try
            {
                    object[] objRow = ObjectUtil.GetObjects(Context.ProcessDispatcher.WriteToService("CranePLC4", "CraneAlarmCode"));
        ...
        private void cmbHeight_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataTable dt;
            DataView dv;
            if (this.cmbHeight.SelectedIndex==0)
            {
            ...
            else
            {
                param = new DataParameter[] 
                     { 
                         new DataParameter("{0}", string.Format("ShelfCode='{0}' and CellColumn={1} and CellRow={2}",this.cbRow.Text,this.cbColumn.Text,"4"))
                     };
                dt = bll.FillDataTable("CMD.SelectCell", param);
                 dv = dt.DefaultView;
                dv.Sort = "CellRow";
        ...
        private void btnRequest_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable dtState = bll.FillDataTable("WCS.SelcetWcsState", new DataParameter[] { new DataParameter("{0}", "04"), new DataParameter("{1}", 10), new DataParameter("{2}", "(WCS_TASK.State='3' and (WCS_TASK.TaskType='12' or WCS_TASK.TaskType='14')) or Wcs_Task.State='13'") });
                if (dtState.Rows.Count == 0)
                {
                    DataTable dtState1 = new DataTable();
                     dtState1 = bll.FillDataTable("WCS.SelcetWcsState", new DataParameter[] { new DataParameter("{0}", "04"), new DataParameter("{1}", 1), new DataParameter("{2}", "(WCS_TASK.State='10')") });
                    ...
                    { 
                      ...
                      new DataParameter("@AisleNo",this.cmbAisleNo.Text)
                        ...
                        if (this.radioButton1.Checked)
                        {
                            ...
                            {
                                dt = bll.FillDataTable("WCS.sp_GetCellByAisle1", param);
                            }
                            if (dt.Rows.Count > 0)
                            {
                    ...
                    {             
                        ...
                        int TaskHeight = cmbHeight.SelectedIndex;
                        ...
                        Context.ProcessDispatcher.WriteToService("TranLine", "Height", cmbHeight.SelectedIndex);
