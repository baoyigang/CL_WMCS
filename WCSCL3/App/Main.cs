...
namespace App
{
    public partial class Main : Form
    {
        ...
        {
            DataTable dt = bll.FillDataTable("WCS.SelectTask", new DataParameter[] { new DataParameter("{0}", "((WCS_TASK.TaskType='11' and WCS_TASK.State in('1','2','3','12')) OR (WCS_TASK.TaskType in('12','13') and WCS_TASK.State in('0','3','10','13')) OR (WCS_TASK.TaskType in('14') and WCS_TASK.State in('0','3','4','5','6','10','12','13'))) And WCS_TASK.AreaCode='" + BLL.Server.GetAreaCode() + "'") });
            return dt;
        }
        ...
        private void ToolStripMenuItemTranLine_Click(object sender, EventArgs e)
        {
            if (this.dgvMain.CurrentCell != null)
            {
                ...
                context.ProcessDispatcher.WriteToService("TranLine", "SlideNum", aisleNo);
