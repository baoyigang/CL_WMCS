<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InStockTasks.aspx.cs" Inherits="WebUI_InStock_InStockTasks" %>
                    ...
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="10" SkinID="GridViewSkin" Width="100%">
                        <Columns>
                           ...
                           <asp:BoundField DataField="Spec" HeaderText="规格" SortExpression="Spec">
                            ...
                            <asp:BoundField DataField="Barcode" HeaderText="熔次卷号" SortExpression="Spec">
                                <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                                <HeaderStyle Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Weight" HeaderText="重量" SortExpression="Spec">
                                <ItemStyle HorizontalAlign="Left" Width="8%" Wrap="False" />
                                <HeaderStyle Wrap="False" />
                            </asp:BoundField>
